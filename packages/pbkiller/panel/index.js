...
const PBKILLER_SETTING_FILE = path.join(Editor.Project ? Editor.Project.path : Editor.projectInof.path, 'settings', 'pbkiller.json');
        ...
        methods: {
            ...
            selectSavePath() {
                let res = Editor.Dialog.openFile({
                    title: "选择要保存的js目录",
                    defaultPath: Editor.Project ? Editor.Project.path : Editor.projectInof.path,
